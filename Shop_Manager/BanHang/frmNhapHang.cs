    ...
    public partial class frmNhapHang : Form {
        ...
        private void btnGiamSanPham_Click(object sender, EventArgs e) {
            try {
                ...
                if (soluongtru == soluonghoadon) {
                    ...
                    int dongia = int.Parse(dataTable.Rows[index2]["DONGIANHAP"].ToString());
        ...
        private void btnThemSanPham_Click(object sender, EventArgs e) {
            try {
                ...
                int soluongnhapthem = (int)numericSoluong.Value;
                ...
                // Tính số lượng sau khi nhập
                int soluongsaukhinhap = soluonghangton + soluongnhapthem;
                dataTable.Rows[index]["SOLUONGTON"] = soluongsaukhinhap;

                // Lấy dữ liệu bên bảng sản phẩm, tính toán và đưa sang bảng hóa đơn
                string tenhang = dataTable.Rows[index]["TENSANPHAM"].ToString();
                int dongia = int.Parse(dataTable.Rows[index]["DONGIANHAP"].ToString());
                string mahang = dataTable.Rows[index]["MASANPHAM"].ToString();
                int tongtien = dongia * soluongnhapthem;
                dataHoaDon.Rows.Add(tenhang, dongia, soluongnhapthem, tongtien, mahang);
        ...
        private void btnThanhToan_Click(object sender, EventArgs e) {
            ...
            String sql =
                string.Format(
                    "INSERT INTO HOADONNHAP (MANHANVIEN,  MANHACUNGCAP,  NGAYNHAP, DAXOA) VALUES( '{0}', '{1}', '{2}', '{3}')",
            ...
            for (int i = 0; i < dataHoaDon.Rows.Count; i++) {
                ...
                sql = string.Format("INSERT INTO CHITIETHOADONNHAP(MAHOADON, MASANPHAM, DONGIA, SOLUONG) VALUES('{0}', '{1}', '{2}', '{3}')", mahoadon, masp, dongia, soluong);
                SQLHelper.chayTruyVan(sql);
            }
        ...
        private void cbKhachHang_SelectedIndexChanged(object sender, EventArgs e) {
            ...
            if (index < 0)
                return;
            txtMaKhach.Text = dataKhachHang.Rows[index]["MANHACUNGCAP"].ToString();
        ...
        private void frmNhapHang_Load(object sender, EventArgs e) {
            ...
            string strSQL = "SELECT MANHACUNGCAP, TENNHACUNGCAP, DIACHI, EMAIL, SODIENTHOAI FROM NHACUNGCAP WHERE DAXOA = 0";
            ...
            cbKhachHang.ValueMember = "MANHACUNGCAP";
            cbKhachHang.DisplayMember = "TENNHACUNGCAP";

            // Lấy dữ liệu từ CSDL
            strSQL = "SELECT MASANPHAM, TENSANPHAM, DONGIANHAP, SOLUONGTON FROM SANPHAM WHERE SOLUONGTON > 0 AND DAXOA = 0";
